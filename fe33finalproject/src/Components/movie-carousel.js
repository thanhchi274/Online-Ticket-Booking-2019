    ...
    render() {
        ...
        return (
                ...
                <div className="movie-carousel">
                    ...
                    <LazyLoadImage src={movie.hinhAnh} style={{border: '1px solid black',borderRadius: '20px'}} className="img-fluid carousel-image-home" effect="blur" height={395} width={250}/> 
                    </Link>
                    </div>
                {/* </NavLink> */}
                {/* <div className="carousel-body">
                    ...
                    <div className="carousel-detail" style={{border: '1px solid black',borderRadius: '20px'}}>
