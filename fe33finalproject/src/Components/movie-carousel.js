    ...
    render() {
        ...
        return (
                ...
                <div className="movie-carousel">
                    ...
                    <LazyLoadImage src={movie.hinhAnh} style={{border: '1px solid black',borderRadius: '20px'}} className="img-fluid carousel-image-home" effect="blur" height={350} width={250}/> 
                    </Link>
                    </div>
                {/* </NavLink> */}
